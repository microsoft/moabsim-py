...
# Moab example demonstrating AI learning a general policy despite being
# stochastic because noise is added to the actuator for plate angles. 
# The noise is a gaussian with a mean of zero and a sigma of scalar/3
...
type SimConfig {
    ...
    # Add actuator noise to plate angles
    plate_noise: number,
}
